...
bot = telebot.TeleBot('6213173754:AAHLKOCUov0-I4wUxmeMWT1wt7J6nvQwblk')

# Admin user IDs
admin_id = ["6875009871","1249726999"]
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "KOI BAAT NAHI BHAI BUY KAR LE YR @Anonymous0032 ❤."
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, FUCK BGMI.👙👙\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- @Anonymous0032 BHAI PLZ BUY KAR LE"
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command.                                                                          DM TO BUY ACCESS:- @Anonymous0032")
...
Buy From :- @Anonymous0032
Official Channel :- https://t.me/SG_Modder1
'''
...
3. MAKE SURE YOU JOINED https://t.me/SG_Modder1 OTHERWISE NOT WORK
